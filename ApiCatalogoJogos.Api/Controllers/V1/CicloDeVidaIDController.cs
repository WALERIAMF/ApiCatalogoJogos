...
namespace ApiCatalogoJogos.Api.Controllers
{
    ...
    public class CicloDeVidaIDController : ControllerBase
    {
        ...
        public Task<string> Get()
        {
            ...
            stringBuilder.AppendLine($"Singleton 1: {_exemploScoped2.Id}");
            stringBuilder.AppendLine();
            stringBuilder.AppendLine($"Singleton 1: {_exemploTransient1.Id}");
            stringBuilder.AppendLine($"Singleton 1: {_exemploTransient2.Id}");
